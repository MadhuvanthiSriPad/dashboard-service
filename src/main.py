...
@app.get("/api/contracts/sync-status")
async def contracts_sync_status(request: Request):
    return await _proxy(_client(request), f"{GATEWAY}/api/v1/contracts/sync-status")
